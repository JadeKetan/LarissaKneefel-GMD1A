...
{
    public float maxAngle1 = 30.0f; //maximale hoek die gemaakt kan worden door de flipper
    public float flipTime1 = 0.1f; //snelheid waarme de flipper draait... hoe lager waarde hoe sneller
    public string buttonName1 = "Vertical"; //(mouse)button for activation flipper rotation
